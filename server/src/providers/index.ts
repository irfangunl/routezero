...
// OpenCode Zen — OpenAI-compatible. Free models: deepseek-v4-flash-free,
// qwen3.6-plus-free, minimax-m2.5-free, nemotron-3-super-free, big-pickle.
// No API key required for free models (public endpoint), but key-based auth
// also supported for paid tiers.
register(
  new OpenAICompatProvider({
    platform: "opencode",
    name: "OpenCode Zen",
